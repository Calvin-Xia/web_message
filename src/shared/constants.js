...
export const DISTRESS_TYPE_VALUES = ['academic_pressure', 'relationship', 'adaptation', 'mood', 'sleep', 'other'];
export const SCENE_TAG_VALUES = ['dormitory', 'classroom', 'library', 'self_study', 'cafeteria', 'playground', 'other'];
